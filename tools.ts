...
<section>
  ...
  <p>
    The <strong>${topic}</strong> is a practical BTTOTEK calculator for
    ${category.toLowerCase()} work. It is designed to make repetitive
  ...
  <p>
    <strong>Calculation method:</strong> ${formula}
  </p>
