...
function RichTextEditor({
  ...
  useEffect(() => {
    // Never rewrite the contentEditable DOM while the user is typing.
    // Mobile browsers can temporarily move activeElement during a React
    // render; the explicit focus ref prevents the editor from resetting
    // the caret/content in that window.
    if (!ref.current || focusedRef.current || document.activeElement === ref.current) return;
      ...
      <div className="overflow-hidden rounded-md border border-input bg-background">
        ...
        {htmlMode ? (
          ...
          <div
            ...
            style={{ minHeight, WebkitUserModify: "read-write" }}
          ...
          <aside className="space-y-5">
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <div className="mt-4 space-y-2">
                ...
                >
                  {published ? "Move to Draft & Save" : "Publish & Save"}
                </button>
              </div>
            </div>
