...
function LayoutPanel() {
  ...
  async function uploadLogo(file: File) {
    ...
    try {
      ...
      const filePath = `logo/logo-${Date.now()}.${extension}`;
      ...
      toast.success("Logo uploaded. Click Save Full Website Settings to publish it.");
    } finally {
      ...
      <section className="surface-panel p-5">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <div className="grid gap-2">
            ...
            <label className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-dashed border-border bg-background px-4 py-3 text-sm font-semibold hover:bg-secondary">
              {logoUploading ? (
                <Loader2 className="size-4 animate-spin" />
              ) : (
            ...
            {draft.logoUrl ? (
              <div className="relative mt-1 overflow-hidden rounded-lg border border-border bg-background p-4">
                <img
                  src={draft.logoUrl}
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center gap-1 rounded-md border border-border px-2.5 py-1.5 text-xs font-semibold hover:bg-secondary hover:text-destructive"
                >
