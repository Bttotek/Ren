// BTTOTEK MASTER ADMIN
// Built directly from the supplied admin-console.tsx base.
// Existing Supabase architecture, navigation and tool registry are preserved.
// Feature-specific controls remain scoped to their own panels.
...
function FullModuleEditor({
  ...
  return (
    <div className="space-y-5 rounded-xl border border-border bg-card p-6 shadow-sm">
      ...
      <label className="block">
        <span className={labelCls}>Subheading / Description</span>
            ...
            <div className="space-y-5">
              ...
              <label className="grid gap-1">
                ...
                <textarea
                  ...
                  rows={10}
                  className={fieldCls}
                  placeholder="Full calculator content..."
                />
              </label>
            </div>
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              <label className="grid gap-1">
                ...
                <textarea
                  ...
                  className={
                    "mt-1 w-full rounded-md border border-input bg-background p-4 text-sm leading-7 outline-none focus:border-accent"
                  }
                />
              </label>
            </div>
      ...
      <div className="rounded-xl border border-border bg-card p-5">
        ...
        <div className="mt-4 grid gap-3">
          ...
          <textarea
            ...
            rows={4}
            className={
              "w-full rounded-md border border-input bg-background p-3 text-sm outline-none"
            }
          />
